...
#ifndef _GOOGLE_IAP_H_
#define _GOOGLE_IAP_H_
...
namespace sdkbox
{
    ...
    struct Product
    {
        ...
        receipt(""), transactionID(""), purchaseToken("") {}
    ...
    */
    ...
    public:
        ...
        */
        virtual void onFailure(const Product& p, const std::string& errorMsg, int errorCode) = 0;
        ...
        */
        ...
        /**
        * Called when an Restore fails
        */
        virtual void onRestoreFailure(const Product& p, const std::string& errorMsg, int errorCode) = 0;
        virtual void onQueryPurchasesSuccess(const std::vector<Product>& products) = 0;
        virtual void onQueryPurchasesFailure(int errorCode, const std::string& errorMsg) = 0;
        ...
        */
        virtual void onProductRequestFailure(const std::string& errorMsg) = 0;
         ...
         */
        virtual void onConsumed(const Product& p) = 0;

        /**
         * Called when consume failed
         */
         virtual void onConsumeFailure(const Product& p, const std::string& errorMsg, int errorCode) = 0;
        ...
        virtual void onPlayPassStatusUpdate(bool active, const std::string& productToken) = 0;
        virtual void onUnConsumedProductsUpdate(const std::vector<Product>& products) = 0;
    };
    ...
    public:
        ...
        */
        ...
        /**
         * Initialize Play Pass
        */
       static void initPlayPass(const std::string& noAdsPackId);
        ...
        */
        ...
        static void consume(const std::string& productId, const std::string& purchaseToken);
        ...
        */
        ...
        /**
         * Query unconsumed consumable items
         */
        static void queryUnconsumedPurchases();
