...
SE_DECLARE_FUNC(js_PluginIAPJS_IAP_consume);
...
SE_DECLARE_FUNC(js_PluginIAPJS_IAP_queryPurchases);
...
SE_DECLARE_FUNC(js_PluginIAPJS_IAP_initPlayPass);
...
SE_DECLARE_FUNC(js_PluginIAPJS_IAP_isEnabled);
